...
checkboxGroupInput("course_selected_LDA", "Courses", unique(tdm_course$`Course Title`)[1:20], unique(tdm_course$`Course Title`)[10:20])
...
checkboxGroupInput("cluster_selected_LDA", "Cluster", unique(d_course$Cluster[!is.na(d_course$Cluster)]), unique(d_course$Cluster[!is.na(d_course$Cluster)]))
