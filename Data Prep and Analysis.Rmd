...
We have already used the first plot to provide a label to the topics. Together with the second plot, it gives us an idea of the content of the topics.

The second plot of the model with 25 topics also shows that half of the topics are covered by several clusters and the other half are almost exclusively present in only one cluster. One of the objectives of the Liberal Arts program is to provide students with a interdisciplinary perspective on the . For instance, approaching the issue of tackling climate change from a legal, economics, ecological and ethical perspective. To accomplish this, topics should be covered by different clusters, in order to encourage students to take classes in different disciplines, thereby broading their acadmeic horizon

Once we have a good idea of what each topic contains (and have potentially even labeled them), the third plot gives us an overview of the topic covered by each course and cluster. 
