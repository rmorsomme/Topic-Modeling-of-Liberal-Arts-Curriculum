...
We have already used the first plot to provide a label to the topics. Toegether with the second plot, it gives us an idea of the content of the topics. Once we have a good idea of what each topic contains (and have potentially even labeled them), the third plot gives us an overview of the topic covered by each course and cluster. 

2nd plots => topics covered in several courses => good for liberal arts.
